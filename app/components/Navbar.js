...
export default function Navbar() {
  return (
    <nav className="flex justify-evenly px-8 py-4 backdrop-blur bg-darkblue/80  text-white">
      <div className="flex items-center ml-80">
        <Logo className='mr-20'></Logo>

        <div className="hidden md:flex space-x-8 text-white">
          <a href="#" className="hover:text-light-blue font-display tracking-extraWide text-yellow">DISCOVER</a>
